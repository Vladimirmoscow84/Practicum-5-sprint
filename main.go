...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed(), 2)/w.Height/100)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return float64(s.LengthPool) * float64(s.CountPool) / float64(MInKm)
}
